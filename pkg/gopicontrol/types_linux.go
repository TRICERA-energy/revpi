...
// cgo -godefs=true -- -I/home/niklas/Repository/revpi/pkg/gopicontrol/interface ctypes_linux.go
...
const (
	...
	REV_PI_DEV_FIRST_RIGHT		= 0x20
	REV_PI_DEV_CNT_MAX		= 0x40
	REV_PI_ERROR_MSG_LEN		= 0x100
	KB_RESET			= 0x4b0c
	...
	PICONTROL_UPLOAD_FIRMWARE	= 0x40084bc8
